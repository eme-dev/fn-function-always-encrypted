...
CREATE TABLE [ae].[ClienteAE](
    ...
    [DatosJson] [nvarchar](MAX) COLLATE Latin1_General_BIN2 ENCRYPTED WITH (COLUMN_ENCRYPTION_KEY = [CEK_AKV], ENCRYPTION_TYPE = Randomized, ALGORITHM = 'AEAD_AES_256_CBC_HMAC_SHA_256') NULL,
...
INSERT INTO ae.ClienteAE (Nombre, DNI, DatosJson)
VALUES (@Nombre, @DNI, @DatosJson);
